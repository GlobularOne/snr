...
from snr.core.core import arch, common_paths, options, console
...
def _check_for_libsnr() -> None:
    try:
        ...
        common_utils.print_sys("--> The now obsolete libsnr found! It is no longer supported neither is used, remove it")
...
def _handle_init(do_init: bool, do_reinit: bool) -> None:
...
def _main(verbose: bool, quiet: bool, payload_arch: str, do_init: bool, do_reinit: bool,
          host_primary_nameserver: str, host_secondary_nameserver: str,
          host_hostname: str, default_exit_code: int, debug: bool, show_version: bool) -> None:
    ...
    _handle_init(do_init, do_reinit)
